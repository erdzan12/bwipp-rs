#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `Ean13`
...
//!
//!   cargo +nightly fuzz run fuzz_ean -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::Ean13, &payload, &Options::default());
});
