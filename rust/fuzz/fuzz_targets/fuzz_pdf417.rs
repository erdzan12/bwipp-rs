#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `Pdf417`
...
//!
//!   cargo +nightly fuzz run fuzz_pdf417 -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::Pdf417, &payload, &Options::default());
});
