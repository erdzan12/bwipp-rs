#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `Code49`
...
//!
//!   cargo +nightly fuzz run fuzz_code49 -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::Code49, &payload, &Options::default());
});
