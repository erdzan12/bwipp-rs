#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `CompositeEan13Cca`
...
//!
//!   cargo +nightly fuzz run fuzz_composite_cca -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::CompositeEan13Cca, &payload, &Options::default());
});
