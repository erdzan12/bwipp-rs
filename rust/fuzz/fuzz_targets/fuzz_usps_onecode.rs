#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `UspsOneCode`
...
//!
//!   cargo +nightly fuzz run fuzz_usps_onecode -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::UspsOneCode, &payload, &Options::default());
});
