#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `CompositeGs1_128Ccc`
...
//!
//!   cargo +nightly fuzz run fuzz_composite_ccc -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::CompositeGs1_128Ccc, &payload, &Options::default());
});
