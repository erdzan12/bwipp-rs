#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `Maxicode`
...
//!
//!   cargo +nightly fuzz run fuzz_maxicode -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::Maxicode, &payload, &Options::default());
});
