#![no_main]
//! Stage 11.A8d — dedicated cargo-fuzz target for the `Code16k`
...
//!
//!   cargo +nightly fuzz run fuzz_code16k -- -max_total_time=30
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = render_svg(Symbology::Code16k, &payload, &Options::default());
});
